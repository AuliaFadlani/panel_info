...
Uses
  StdCtrls, Forms, SysUtils, Dialogs, Windows, Classes, Controls,
  ExtCtrls, graphics;
...
type
  ...
  private
    ...
    procedure PanelProperties(TrianglePanelName, rounded_panel: TPanel);
...
begin
  ...
  begin
    lbl.Caption := kata;
    LBmp.Canvas.Font := lbl.Font;
    lbl.Width := LBmp.Canvas.TextWidth(lbl.Caption);

    if (lbl.Width >= 225) then
    begin
      LabelName.Height := (lbl.Width div 225) * 16;
    ...
    begin
      PanelName.Top := TrianglePanelName.Top + TrianglePanelName.Height - 1;
    ...
    begin
      ...
      PanelName.Left := TrianglePanelName.Left - PanelName.Width + 2;
    end
    else
    begin
      PanelName.Top := TrianglePanelName.Top - ((PanelName.Height - TrianglePanelName.Height) div 2);
      PanelName.Left := TrianglePanelName.Left + TrianglePanelName.Width - 1;
    end;
...
procedure TPanelInfo.RunTimer(Sender: TObject);
begin
  Inc(Counter);
